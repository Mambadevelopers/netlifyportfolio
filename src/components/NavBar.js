...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px8">
    ...
    <nav>
      ...
      <nav className="flex items-center justify-center flex-wrap">
        ...
        <motion.a
          ...
          whileHover={{ y: -2 }}
          whileTap={{scale: 0.9}}
          className="w-6 mx-3  bg-primary rounded-full"
        >
          <GithubIcon />
        </motion.a>
    ...
    <nav className="flex items-center flex-col justify-center">
      ...
      <nav className="flex items-center justify-center flex-wrap mt-2">
        ...
        <motion.a
          ...
          whileHover={{ y: -2 }}
          whileTap={{scale: 0.9}}
          className="w-6 mx-3  bg-primary rounded-full sm:mx-1"
        >
          <GithubIcon />
        </motion.a>
        ...
        onClick={() => setMode(mode === "light" ? "dark" : "light")}
        className={`
        ml-3 flex items-center justify-center rounded-full sm:mx-1 p-1 ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}
        `}
        >
          {
            mode === "dark" ?
